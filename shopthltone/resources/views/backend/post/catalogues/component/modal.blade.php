	...
	<div class="row">
		...
		<div class="col-sm-3">
			<div class="ibox-tools text-right">
				...
				@endif
				<button class="btn btn-default dropdown-treeCat" type="button" data-toggle="dropdown"><i class="fa fa-bars" aria-hidden="true"></i></button>
			</div>
		</div>
	</div>
	<div class="ibox-post-catalogue">
		<div id="jstree1">
			<ul>
				<li class="jstree-open">Main Catalogue
				{{!!$treeCat!!}}
				</li>
			</ul>
		</div>
