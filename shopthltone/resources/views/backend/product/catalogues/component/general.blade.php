	...
	<div class="row mb15">
		<div class="col-lg-12">
			<div class="form-group">
				...
				<input type="text" placeholder="Tiêu đề nhóm bài viết" class="form-control" name="name" value="{{ old('name',($productCat->name) ?? '') }}" />
			</div>
		</div>
	</div>
	<div class="row mb15">
		<div class="col-lg-12">
			<div class="form-group">
				...
				@foreach($dropdown as $k => $d)
					<option value="{{$k}}" {{$k==old('parentid',(isset($productCat->parentid))?$productCat->parentid:'')?'selected':''}}>{{$d}}</option>
				@endforeach
				</select>
			</div>
		</div>
	...
	<div class="row mb15">
		<div class="col-lg-12">
			<div class="form-group">
				...
				<textarea class="form-control ck-editor" id="description" name="description" data-height="250">{{ old('description',($productCat->description) ?? '') }}</textarea>
			</div>
		</div>
	</div>
	<div class="row mb15">
		<div class="col-lg-12">
			<div class="form-group">
				...
				<textarea class="form-control ck-editor" id="ckContent" name="content" data-height="500">{{ old('content',($productCat->content) ?? '') }}</textarea>
