...
@php 
$action = (isset($method) && $method == 'create') ? route('product.catalogue.store') : route('product.catalogue.update',['id'=>$productCat->id]);
@endphp
	<form method="POST" action="{{$action}}">
	@csrf
		@include('backend.product.catalogues.component.modal')
	    ...
	    <div class="row">
	        <div class="col-lg-9">
	        	<div class="ibox tabs-container">
	        		...
	        		<div class="ibox-content tab-content">
	        			@include('backend.product.catalogues.component.general')
						@include('backend.product.catalogues.component.seo')
	        ...
	        <div class="col-lg-3">
	            @include('backend.product.catalogues.component.aside')
	        </div>
	    </div>
	</form>
		...
		<div class="modal-dialog">
			<div class="modal-content animated fadeIn">
				<div class="modal-body">
					<form action="{{route('product.catalogue.destroy',['id'=>$productCat->id])}}" method="product">
					@csrf
						<p>Bạn có chắc chắn muốn xóa danh mục <span class="text-danger text-bold">{{$productCat->name}}</span></p>
