	...
	<div class="row">
		<div class="col-lg-12">
			<div class="form-group">
				...
				<input type="text" placeholder="" class="form-control" name="meta_title" value="{{ old('meta_title',($data->meta_title) ?? '') }}" />
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-lg-12">
			<div class="form-group">
				...
				<input type="text" placeholder="" class="form-control" name="meta_keyword" value="{{ old('meta_keyword',($data->meta_keyword) ?? '') }}" />
			</div>
		</div>
	</div>
	<div class="row">
		...
		<div class="col-lg-12">
			<div class="form-group">
				...
				<div class="canonical-wrapper">
					<input type="text" placeholder="" class="form-control" name="canonical" value="{{ old('canonical',($data->canonical) ?? '') }}" />
