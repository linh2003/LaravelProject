	...
	<div class="row">
		<div class="col-lg-12">
			<div class="form-group">
				...
				<input type="text" placeholder="" class="form-control" name="meta_title" value="{{ old('meta_title',($attribute->meta_title) ?? '') }}" />
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-lg-12">
			<div class="form-group">
				...
				<input type="text" placeholder="" class="form-control" name="meta_keyword" value="{{ old('meta_keyword',($attribute->meta_keyword) ?? '') }}" />
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-lg-12">
			<div class="form-group">
				...
				<textarea class="form-control" id="meta_description" name="meta_description" rows="8">{{ old('meta_description',($attribute->meta_description) ?? '') }}</textarea>
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-lg-12">
			<div class="form-group">
				...
				<div class="canonical-wrapper">
					<input type="text" placeholder="" class="form-control" name="canonical" value="{{ old('canonical',($attribute->canonical) ?? '') }}" />
