<div class="wrapper wrapper-content animated fadeInRight">
	@php $action = $method=='create' ? route('admin.product.store') : route('admin.product.update', $data->id) @endphp
	<form method="POST" action="{{$action}}">
		@csrf
		@include('backend.product.product.component.modal')
	        ...
	        <div class="col-lg-9">
	        	<div class="ibox tabs-container">
					<ul class="nav nav-tabs">
						...
						<li class=""><a data-toggle="tab" href="#tab-4"><h5>{{$heading['create']['tab'][3]}}</h5></a></li>
					</ul>
		...
		<div class="modal-dialog">
			<div class="modal-content animated fadeIn">
				<div class="modal-body">
					<form action="{{route('admin.product.delete',['id'=>$data->id])}}" method="POST">
					@csrf
