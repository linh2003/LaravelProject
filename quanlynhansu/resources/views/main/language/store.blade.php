@include(
	...
	[
		'breadcrumb_before' => __('language.index.title'),
		'breadcrumb_after'  => (isset($method) && $method=='create') ? __('language.create.title') : __('language.update.title')
	]
)
							...
							<div class="col-sm-6">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10 col-form-label">
										<input type="checkbox" class="js-switch js-small" name="active" value="0">
									</div>
								</div>
							</div>
